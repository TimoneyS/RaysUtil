...
public class Https {
    ...
    public static byte[] doPost(String uri, String data, Map<String, String> head) throws IOException {
        HttpsURLConnection httpsConn = getHttpsURLConnection(uri, "POST", head);
